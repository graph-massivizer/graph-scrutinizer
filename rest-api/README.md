...
## Testing a request
    ...
    curl --request POST --header "Content-Type: application/json" --data '{"graph_processing_action": "graph-summarization", "graph_path": "file:///input/graphs/use-case-graph.csv"}'  http://0.0.0.0:8000/scrutinizer/requests
...
Now, the graph_processing_id can be used to retrieve the status of the job
